...
router.get("/all", Best_tens_1.getAllGames);
router.get("/:gameID", Best_tens_1.getGameById);
router.put("/:gameID", Best_tens_1.updateGame);
router.delete("/:gameID", Best_tens_1.deleteGame);
